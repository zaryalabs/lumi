...
Безопасные compatibility-отклонения не переводят job в `failed`:
неканонический position/compression `mimetype`, отдельный пустой spine item и
unsupported rich block сохраняются как diagnostics. Job завершается ошибкой,
если после recoverable normalization во всей книге нет читаемого unit или
безопасного placeholder.
