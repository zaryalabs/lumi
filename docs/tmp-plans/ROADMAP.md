...
search runtime. Social vertical публикует `community-spaces`,
...
Первый post-`0.5.0` hardening epic вынесен в отдельный
[`POST-0.5.0-ROADMAP.md`](POST-0.5.0-ROADMAP.md), чтобы не переоткрывать
завершённую продуктовую шкалу `0.2.0–0.5.0`.
