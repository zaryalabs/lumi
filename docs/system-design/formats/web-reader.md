...
импорта - `DocumentRevision` and Normalized Content Package; reader строит
...
18. Создать `DocumentRevision`, Normalized Content Package, `ReadingDocument`
...
- **Reader.** Web importer выдает Normalized Content Package; `ReadingDocument`
