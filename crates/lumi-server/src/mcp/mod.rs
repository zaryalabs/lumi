...
use lumi_core::{
    ...
    DeleteSharedCommentRequest, DeskItemFilter, DeskLearningState, DeskObjectType, DeskSort,
    GenerateLearningItemsRequest, ListLearningItemsRequest, MaterialDesk, McpAiTaskProgressRequest,
    McpConnection, McpConnectionId, McpConnectionStatus, McpConnectionTokenResponse,
    RetrievalContextPolicy, RetrievalRequest, RevokeMcpConnectionRequest,
    RotateMcpConnectionRequest, SearchRankingProfile, SearchRequest, SearchScope, SearchSourceType,
    ShareMaterialRequest, SubmitLearningAnswerRequest, SubmitLearningAttemptCommand,
    UpdateSharedCommentRequest, UserId, MAX_SEARCH_QUERY_BYTES, MCP_CONTROL_REQUEST_MAX_BYTES,
